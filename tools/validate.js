...
check('Verified Rutgers player attributes surface on player detail overview and attributes tabs', ['J. Elijah','Acceleration','82','Strength','80','Awareness','74'].every(token => jElijahDetailHtml.includes(token)) && !/Height<\/span><strong>N\/A|Weight<\/span><strong>N\/A|Jersey<\/span><strong>N\/A/i.test(jElijahDetailHtml));
